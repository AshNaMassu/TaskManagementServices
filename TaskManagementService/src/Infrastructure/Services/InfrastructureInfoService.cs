...
namespace Infrastructure.Services
{
    ...
    {
        private readonly IKafkaInfoService<KafkaConfigurationOptions, ActivityLogProducerOptions> _kafkaInfoService;

        public InfrastructureInfoService(
            IKafkaInfoService<KafkaConfigurationOptions, ActivityLogProducerOptions> kafkaInfoService)
        {
